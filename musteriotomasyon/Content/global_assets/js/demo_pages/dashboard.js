...
var Dashboard = function () {
    ...
    var _componentDaterange = function () {
        ...
        $('.daterange-ranges').daterangepicker(
            ...
            function (start, end) {
                document.getElementById('myInputstart').value = start.format('DD/MM/YYYY');
                document.getElementById('myInputend').value = end.format('DD/MM/YYYY');
                document.getElementById('myInputstart1').value = start.format('MM/DD/YYYY');
                document.getElementById('myInputend1').value = end.format('MM/DD/YYYY');
        ...
        document.getElementById('myInputstart').value = moment().format('DD/MM/YYYY');
        document.getElementById('myInputend').value = moment().format('DD/MM/YYYY');
        document.getElementById('myInputstart1').value = moment().format('MM/DD/YYYY');
        document.getElementById('myInputend1').value = moment().format('MM/DD/YYYY');


        //$('.daterange-ranges span').html(moment().format('DD/MM/YYYY') + ' - ' + moment().format('DD/MM/YYYY'));
    };
